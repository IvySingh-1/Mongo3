<style>
  .theme-box-info {
    background: rgba(190, 155, 123, 0.08) !important;
    border-left: 5px solid #be9b7b !important;
  ...
  .theme-box-tip {
    background: rgba(133, 68, 66, 0.08) !important;
    border-left: 5px solid #854442 !important;
    padding: 16px !important;
    border-radius: 8px !important;
    margin: 20px 0 !important;
    font-size: 0.95rem !important;
  ...
  .theme-box-warn {
    background: rgba(75, 56, 50, 0.08) !important;
    border-left: 5px solid #4b3832 !important;
    padding: 16px !important;
    border-radius: 8px !important;
    margin: 20px 0 !important;
    font-size: 0.95rem !important;
  ...
  .theme-table {
    ...
    border: 1px solid rgba(190, 155, 123, 0.35) !important;
    margin: 20px 0 !important;
    font-size: 0.95rem !important;
  }
  .theme-table th {
    background-color: rgba(133, 68, 66, 0.15) !important;
    border: 1px solid rgba(190, 155, 123, 0.35) !important;
    padding: 12px !important;
    text-align: left !important;
  }
  .theme-table td {
    border: 1px solid rgba(190, 155, 123, 0.25) !important;
    padding: 12px !important;
  }
  .theme-table tr:nth-child(even) {
    background-color: rgba(190, 155, 123, 0.03) !important;
  }
  .theme-card {
  ...
  .theme-card hr {
    ...
    background: rgba(190, 155, 123, 0.25) !important;
  ...
  .theme-social-btn {
    ...
    border: 1px solid #be9b7b !important;
...
<div class="theme-box-info" style="background: rgba(190, 155, 123, 0.08); border-left: 5px solid #be9b7b; padding: 16px; border-radius: 8px; margin: 20px 0; font-size: 0.95rem; line-height: 1.6;">
...
<table class="theme-table" style="width: 100%; border-collapse: collapse; border: 1px solid rgba(190, 155, 123, 0.35); margin: 20px 0; font-size: 0.95rem;">
  <thead>
...
<div class="theme-box-tip" style="background: rgba(133, 68, 66, 0.08); border-left: 5px solid #854442; padding: 16px; border-radius: 8px; margin: 20px 0; font-size: 0.95rem; line-height: 1.6;">
...
<div class="theme-box-warn" style="background: rgba(75, 56, 50, 0.08); border-left: 5px solid #4b3832; padding: 16px; border-radius: 8px; margin: 20px 0; font-size: 0.95rem; line-height: 1.6;">
...
<div align="center">
<div class="theme-card" style="background-color: #3c2f2f; border: 2px solid #be9b7b; border-radius: 16px; padding: 30px; max-width: 650px; margin: 30px auto 20px auto; color: #fff4e6; font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif; box-shadow: 0 8px 24px rgba(0,0,0,0.35);">
...
<a class="theme-social-btn" href="https://github.com/IvySingh-1" target="_blank" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 50%; background: #854442; border: 1px solid #be9b7b; margin: 0 5px; vertical-align: middle;">
...
<a class="theme-social-btn" href="https://www.linkedin.com/in/ivysingh99/" target="_blank" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 50%; background: #854442; border: 1px solid #be9b7b; margin: 0 5px; vertical-align: middle;">
...
<a class="theme-social-btn" href="https://x.com/ivysingh99" target="_blank" style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 50%; background: #854442; border: 1px solid #be9b7b; margin: 0 5px; vertical-align: middle;">
